...
use crate::v2::lu_dog_pl_vec::types::field_expression::FieldExpressionEnum;
...
impl UnnamedFieldExpression {
    ...
    pub fn new(position: i64, store: &mut LuDogPlVecStore) -> Arc<RwLock<UnnamedFieldExpression>> {
