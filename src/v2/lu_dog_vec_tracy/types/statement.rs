...
use crate::v2::lu_dog_vec_tracy::types::item_statement::ITEM_STATEMENT;
...
impl Statement {
    ...
    pub fn r18_block<'a>(&'a self, store: &'a LuDogVecTracyStore) -> Vec<Rc<RefCell<Block>>> {
        span!("r18_block");
    ...
    pub fn r71c_block<'a>(&'a self, store: &'a LuDogVecTracyStore) -> Vec<Rc<RefCell<Block>>> {
        span!("r71_block");
        let block = store
            .iter_block()
