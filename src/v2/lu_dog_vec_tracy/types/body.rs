...
use crate::v2::lu_dog_vec_tracy::types::external_implementation::ExternalImplementation;
...
impl Body {
    ...
    pub fn r73c_lambda<'a>(&'a self, store: &'a LuDogVecTracyStore) -> Vec<Rc<RefCell<Lambda>>> {
        span!("r73_lambda");
        let lambda = store
            .iter_lambda()
