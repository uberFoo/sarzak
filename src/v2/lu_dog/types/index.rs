...
impl Index {
    ...
    pub fn new(
        ...
        let id = Uuid::new_v4();
        let new = Rc::new(RefCell::new(Index {
            id,
    ...
    pub fn r56_expression<'a>(&'a self, store: &'a LuDogStore) -> Vec<Rc<RefCell<Expression>>> {
        span!("r56_expression");
    ...
    pub fn r57_expression<'a>(&'a self, store: &'a LuDogStore) -> Vec<Rc<RefCell<Expression>>> {
        span!("r57_expression");
