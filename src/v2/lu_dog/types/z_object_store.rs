...
use crate::v2::lu_dog::types::object_wrapper::ObjectWrapper;
...
impl ZObjectStore {
    ...
    pub fn new(domain: String, name: String, store: &mut LuDogStore) -> Rc<RefCell<ZObjectStore>> {
        let id = Uuid::new_v4();
        let new = Rc::new(RefCell::new(ZObjectStore { domain, id, name }));
