...
impl Print {
    ...
    pub fn new(expression: &Arc<Mutex<Expression>>, store: &mut LuDogStore) -> Arc<Mutex<Print>> {
        let id = Uuid::new_v4();
    ...
    pub fn r32_expression<'a>(&'a self, store: &'a LuDogStore) -> Vec<Arc<Mutex<Expression>>> {
