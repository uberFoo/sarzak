...
use crate::v2::lu_dog_pl_mutex::types::woog_option::WoogOptionEnum;
...
impl ZSome {
    ...
    pub fn new(inner: &Arc<Mutex<XValue>>, store: &mut LuDogPlMutexStore) -> Arc<Mutex<ZSome>> {
        let id = Uuid::new_v4();
    ...
    pub fn r23_x_value<'a>(&'a self, store: &'a LuDogPlMutexStore) -> Vec<Arc<Mutex<XValue>>> {
        span!("r23_x_value");
