...
pub fn new_from(lhs: Option<&Expression>,rhs: Option<&Expression>,store: &mut LuDogVanillaStore,) -> RangeExpression {
let id = Uuid::new_v4();
...
/// Inter a new RangeExpression in the store, and return it's `id`.
pub fn new_full(lhs: Option<&Expression>,rhs: Option<&Expression>,store: &mut LuDogVanillaStore,) -> RangeExpression {
let id = Uuid::new_v4();
let new = RangeExpression {
lhs: lhs.map(|expression| expression.id()),
rhs: rhs.map(|expression| expression.id()),
...
/// Inter a new RangeExpression in the store, and return it's `id`.
pub fn new_inclusive(lhs: Option<&Expression>,rhs: Option<&Expression>,store: &mut LuDogVanillaStore,) -> RangeExpression {
let id = Uuid::new_v4();
let new = RangeExpression {
lhs: lhs.map(|expression| expression.id()),
rhs: rhs.map(|expression| expression.id()),
...
/// Inter a new RangeExpression in the store, and return it's `id`.
pub fn new_to(lhs: Option<&Expression>,rhs: Option<&Expression>,store: &mut LuDogVanillaStore,) -> RangeExpression {
let id = Uuid::new_v4();
let new = RangeExpression {
lhs: lhs.map(|expression| expression.id()),
rhs: rhs.map(|expression| expression.id()),
...
/// Inter a new RangeExpression in the store, and return it's `id`.
pub fn new_to_inclusive(lhs: Option<&Expression>,rhs: Option<&Expression>,store: &mut LuDogVanillaStore,) -> RangeExpression {
let id = Uuid::new_v4();
let new = RangeExpression {
lhs: lhs.map(|expression| expression.id()),
rhs: rhs.map(|expression| expression.id()),
