...
use crate::v2::woog_single::types::literal::LITERAL;
...
impl Expression {
    ...
    pub fn new_block(block: &Block, store: &mut WoogSingleStore) -> Self {
    ...
    pub fn new_call(call: &Call, store: &mut WoogSingleStore) -> Self {
    ...
    pub fn r18_x_let<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&XLet> {
        store
            .iter_x_let()
