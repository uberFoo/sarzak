...
use crate::v2::woog_single::types::call::Call;
use crate::v2::woog_single::types::function::Function;
use crate::v2::woog_single::types::function::FunctionEnum;
...
impl ObjectMethod {
    ...
    pub fn new(block: &Block, object: &Object, store: &mut WoogSingleStore) -> ObjectMethod {
        let id = Uuid::new_v4();
    ...
    pub fn r23_block<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&Block> {
    ...
    pub fn r19_call<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&Call> {
        store
            .iter_call()
    ...
    pub fn r25_function<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&Function> {
        vec![store
            .iter_function()
            .find(|function| {
