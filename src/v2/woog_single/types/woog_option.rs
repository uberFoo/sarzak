...
impl WoogOption {
    ...
    pub fn new(ty: &GraceType, store: &mut WoogSingleStore) -> WoogOption {
        let id = Uuid::new_v4();
    ...
    pub fn r20_grace_type<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&GraceType> {
    ...
    pub fn r2_grace_type<'a>(&'a self, store: &'a WoogSingleStore) -> Vec<&GraceType> {
