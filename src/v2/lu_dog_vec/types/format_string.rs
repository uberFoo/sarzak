...
impl FormatString {
    ...
    pub fn r112_format_bit<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<FormatBit>>> {
    ...
    pub fn r111_format_bit<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<FormatBit>>> {
        store
            .iter_format_bit()
