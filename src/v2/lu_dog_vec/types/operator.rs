...
impl Operator {
    ...
    pub fn r50_expression<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<Expression>>> {
        span!("r50_expression");
    ...
    pub fn r51_expression<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<Expression>>> {
        span!("r51_expression");
        match self.rhs {
