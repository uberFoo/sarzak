...
use crate::v2::lu_dog_vec::types::format_bits::FormatBits;
use crate::v2::lu_dog_vec::types::format_bits::FormatBitsEnum;
...
impl ExpressionBit {
    ...
    pub fn r109_expression<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<Expression>>> {
