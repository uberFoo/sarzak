...
impl Comparison {
    ...
    pub fn new_equal(bogus: bool, store: &mut LuDogVecStore) -> Rc<RefCell<Comparison>> {
    ...
    /// Inter a new Comparison in the store, and return it's `id`.
    pub fn new_greater_than(bogus: bool, store: &mut LuDogVecStore) -> Rc<RefCell<Comparison>> {
        store.inter_comparison(|id| {
            Rc::new(RefCell::new(Comparison {
                bogus: bogus,
    ...
    /// Inter a new Comparison in the store, and return it's `id`.
    pub fn new_less_than(bogus: bool, store: &mut LuDogVecStore) -> Rc<RefCell<Comparison>> {
        store.inter_comparison(|id| {
            Rc::new(RefCell::new(Comparison {
                bogus: bogus,
    ...
    /// Inter a new Comparison in the store, and return it's `id`.
    pub fn new_not_equal(bogus: bool, store: &mut LuDogVecStore) -> Rc<RefCell<Comparison>> {
        store.inter_comparison(|id| {
            Rc::new(RefCell::new(Comparison {
                bogus: bogus,
