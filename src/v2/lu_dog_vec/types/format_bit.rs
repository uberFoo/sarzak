...
impl FormatBit {
    ...
    pub fn r113_format_bit<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<FormatBit>>> {
        match self.next {
    ...
    pub fn r113c_format_bit<'a>(&'a self, store: &'a LuDogVecStore) -> Vec<Rc<RefCell<FormatBit>>> {
