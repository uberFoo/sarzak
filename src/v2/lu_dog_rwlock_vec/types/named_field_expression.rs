...
use crate::v2::lu_dog_rwlock_vec::types::field_expression::FieldExpressionEnum;
...
impl NamedFieldExpression {
    ...
    pub fn new(name: String, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<NamedFieldExpression>> {
