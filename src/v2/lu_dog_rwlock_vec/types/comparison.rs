...
impl Comparison {
    ...
    pub fn new_equal(bogus: bool, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<Comparison>> {
    ...
    /// Inter a new Comparison in the store, and return it's `id`.
    pub fn new_less_than(bogus: bool, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<Comparison>> {
        store.inter_comparison(|id| {
            Arc::new(RwLock::new(Comparison {
                bogus: bogus,
    ...
    /// Inter a new Comparison in the store, and return it's `id`.
    pub fn new_not_equal(bogus: bool, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<Comparison>> {
        store.inter_comparison(|id| {
            Arc::new(RwLock::new(Comparison {
                bogus: bogus,
