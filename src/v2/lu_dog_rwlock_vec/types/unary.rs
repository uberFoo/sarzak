...
use crate::v2::lu_dog_rwlock_vec::types::negation::NEGATION;
use crate::v2::lu_dog_rwlock_vec::types::not::NOT;
...
impl Unary {
    ...
    pub fn new_negation(bogus: bool, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<Unary>> {
    ...
    /// Inter a new Unary in the store, and return it's `id`.
    pub fn new_not(bogus: bool, store: &mut LuDogRwlockVecStore) -> Arc<RwLock<Unary>> {
        store.inter_unary(|id| {
            Arc::new(RwLock::new(Unary {
                bogus: bogus,
