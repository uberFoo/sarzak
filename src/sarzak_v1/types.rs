...
use crate::sarzak_v1::store::ObjectStore;
use crate::sarzak_v1::UUID_NS;
...
impl AcknowledgedEvent {
    ...
    /// # use sarzak::sarzak_v1::AcknowledgedEvent;
    /// # use sarzak::sarzak_v1::State;
    /// # use sarzak::sarzak_v1::Event;
    /// # let mut store = sarzak::sarzak_v1::ObjectStore::new();
    ///
...
impl Associative {
    ...
    ///
    ///```
    /// # use sarzak::sarzak_v1::Conditionality;
    /// # use sarzak::sarzak_v1::Cardinality;
    /// # use sarzak::sarzak_v1::AssociativeReferrer;
    /// # use sarzak::sarzak_v1::AssociativeReferent;
...
impl Attribute {
    ...
    ///```
    /// # use sarzak::sarzak_v1::Object;
    /// # use sarzak::sarzak_v1::Attribute;
...
impl Binary {
    ...
    ///
    ///```
    /// # use sarzak::sarzak_v1::Referrer;
    /// # use sarzak::sarzak_v1::Binary;
    /// # use sarzak::sarzak_v1::Object;
    /// # use sarzak::sarzak_v1::Referent;
    /// # use sarzak::sarzak_v1::Conditionality;
    /// # use sarzak::sarzak_v1::Cardinality;
    /// # let mut store = sarzak::sarzak_v1::ObjectStore::new();
    ///
...
impl Isa {
    ...
    ///
    ///```
    /// # use sarzak::sarzak_v1::Supertype;
