...
use crate::sarzak_v2::types::associative::Associative;
...
impl AssociativeUi {
    ...
    pub fn r16_anchor<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Anchor> {
    ...
    pub fn r15_anchor<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Anchor> {
    ...
    pub fn r14_anchor<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Anchor> {
    ...
    pub fn r20_associative<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Associative> {
    ...
    pub fn r17_point<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Point> {
