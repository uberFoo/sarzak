...
// Referrer imports
use crate::drawing_v2::types::edge::Edge;
use crate::drawing_v2::types::point::Point;
use crate::drawing_v2::types::subtype_anchors::SubtypeAnchors;

// Referent imports
use crate::drawing_v2::types::associative_ui::AssociativeUi;
...
impl Anchor {
    ...
    pub fn r3_edge<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Edge> {
    ...
    pub fn r4_point<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Point> {
    ...
    pub fn r5_point<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Point> {
    ...
    pub fn r14c_associative_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&AssociativeUi> {
    ...
    pub fn r16c_associative_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&AssociativeUi> {
        let associative_ui = store
            .iter_associative_ui()
    ...
    pub fn r15c_associative_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&AssociativeUi> {
        let associative_ui = store
            .iter_associative_ui()
    ...
    pub fn r7c_binary_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&BinaryUi> {
        let binary_ui = store
            .iter_binary_ui()
    ...
    pub fn r8c_binary_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&BinaryUi> {
        let binary_ui = store
            .iter_binary_ui()
    ...
    pub fn r9c_isa_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&IsaUi> {
        let isa_ui = store.iter_isa_ui().find(|isa_ui| isa_ui.1.from == self.id);
        match isa_ui {
