...
// Referent imports
use crate::drawing_v2::types::object_edge::ObjectEdge;
...
impl ObjectUi {
    ...
    pub fn r13_point<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Point> {
    ...
    pub fn r18_object_edge<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&ObjectEdge> {
        store
            .iter_object_edge()
