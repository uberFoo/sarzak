...
impl BinaryUi {
    ...
    pub fn r7_anchor<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Anchor> {
    ...
    pub fn r8_anchor<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Anchor> {
    ...
    pub fn r12_binary<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Binary> {
