...
impl ObjectEdge {
    ...
    pub fn new(edge: &Edge, oui_id: &ObjectUi, store: &mut DrawingV2Store) -> ObjectEdge {
    ...
    pub fn r19_edge<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&Edge> {
    ...
    pub fn r18_object_ui<'a>(&'a self, store: &'a DrawingV2Store) -> Vec<&ObjectUi> {
