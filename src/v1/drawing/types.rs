...
use crate::v1::drawing::store::ObjectStore;
use crate::v1::drawing::UUID_NS;
use crate::v1::sarzak::store::ObjectStore as SarzakObjectStore;
...
use crate::v1::sarzak::types::Associative;
use crate::v1::sarzak::types::Binary;
use crate::v1::sarzak::types::Isa;
use crate::v1::sarzak::types::Object;
...
impl Anchor {
    ...
    ///
    ///```
    /// # use sarzak::v1::drawing::Point;
    /// # use sarzak::v1::drawing::Edge;
    /// # use sarzak::v1::drawing::Anchor;
    /// # let mut store = sarzak::v1::drawing::ObjectStore::new();
    ///
...
impl AssociativeUi {
    ...
    ///
    ///```
    /// # use sarzak::v1::drawing::AssociativeUi;
    /// # use sarzak::v1::drawing::Point;
...
impl BinaryUi {
    ...
    /// # use sarzak::v1::drawing::Anchor;
    /// # use sarzak::v1::drawing::Edge;
    /// # use sarzak::v1::drawing::BinaryUi;
    /// # let mut store = sarzak::v1::drawing::ObjectStore::new();
    ///
...
impl ObjectEdge {
    ...
    ///
    ///```
    /// # use sarzak::v1::drawing::ObjectUi;
    /// # use sarzak::v1::drawing::Edge;
    /// # use sarzak::v1::drawing::Point;
    /// # use sarzak::v1::sarzak::Object;
    /// # use sarzak::v1::drawing::ObjectEdge;
    /// # let mut store = sarzak::v1::drawing::ObjectStore::new();
    ///
...
impl SubtypeAnchors {
    ...
    /// # use sarzak::v1::drawing::IsaUi;
    /// # use sarzak::v1::sarzak::Isa;
    /// # use sarzak::v1::drawing::SubtypeAnchors;
    /// # use sarzak::v1::drawing::Point;
    /// # use sarzak::v1::drawing::Edge;
    /// # let mut store = sarzak::v1::drawing::ObjectStore::new();
    ///
