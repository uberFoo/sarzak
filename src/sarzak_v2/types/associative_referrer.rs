...
impl AssociativeReferrer {
    ...
    pub fn new(obj_id: &Object, store: &mut SarzakV2Store) -> AssociativeReferrer {
    ...
    pub fn r26_object<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Object> {
    ...
    pub fn r21_associative<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Associative> {
        vec![
            store
                .iter_associative()
