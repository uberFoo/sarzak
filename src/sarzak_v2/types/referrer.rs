...
impl Referrer {
    ...
    pub fn r9_cardinality<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Cardinality> {
    ...
    pub fn r11_conditionality<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Conditionality> {
    ...
    pub fn r17_object<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Object> {
    ...
    pub fn r6_binary<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Binary> {
        vec![
            store
                .iter_binary()
