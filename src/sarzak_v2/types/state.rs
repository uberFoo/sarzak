...
// Referrer imports
use crate::sarzak_v2::types::acknowledged_event::AcknowledgedEvent;
...
impl State {
    ...
    pub fn new(name: String, obj_id: &Object, store: &mut SarzakV2Store) -> State {
    ...
    pub fn r18_object<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Object> {
