...
impl AssociativeReferent {
    ...
    pub fn new(obj_id: &Object, store: &mut SarzakV2Store) -> AssociativeReferent {
    ...
    pub fn r25_object<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Object> {
    ...
    pub fn r23_associative<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Associative> {
        vec![
            store
                .iter_associative()
    ...
    pub fn r22_associative<'a>(&'a self, store: &'a SarzakV2Store) -> Vec<&Associative> {
        vec![
            store
                .iter_associative()
