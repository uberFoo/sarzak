...
use crate::drawing_v1::store::ObjectStore;
use crate::drawing_v1::UUID_NS;
use crate::sarzak_v1::store::ObjectStore as SarzakObjectStore;
...
use crate::sarzak_v1::types::Associative;
use crate::sarzak_v1::types::Binary;
use crate::sarzak_v1::types::Isa;
...
impl Anchor {
    ...
    ///
    ///```
    /// # use sarzak::drawing_v1::Point;
    /// # use sarzak::drawing_v1::Edge;
    /// # use sarzak::drawing_v1::Anchor;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
...
impl AssociativeUi {
    ...
    ///
    ///```
    /// # use sarzak::drawing_v1::AssociativeUi;
    /// # use sarzak::drawing_v1::Point;
    /// # use sarzak::sarzak_v1::Associative;
    /// # use sarzak::drawing_v1::Edge;
    /// # use sarzak::drawing_v1::Anchor;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
...
impl BinaryUi {
    ...
    ///```
    /// # use sarzak::drawing_v1::Point;
    /// # use sarzak::sarzak_v1::Binary;
    /// # use sarzak::drawing_v1::Anchor;
    /// # use sarzak::drawing_v1::Edge;
    /// # use sarzak::drawing_v1::BinaryUi;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
...
impl IsaUi {
    ...
    ///
    ///```
    /// # use sarzak::sarzak_v1::Isa;
    /// # use sarzak::drawing_v1::Edge;
    /// # use sarzak::drawing_v1::IsaUi;
    /// # use sarzak::drawing_v1::Anchor;
    /// # use sarzak::drawing_v1::Point;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
...
impl ObjectEdge {
    ...
    ///
    ///```
    /// # use sarzak::drawing_v1::ObjectUi;
    /// # use sarzak::drawing_v1::Edge;
    /// # use sarzak::drawing_v1::Point;
    /// # use sarzak::sarzak_v1::Object;
    /// # use sarzak::drawing_v1::ObjectEdge;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
...
impl SubtypeAnchors {
    ...
    /// # use sarzak::drawing_v1::IsaUi;
    /// # use sarzak::sarzak_v1::Isa;
    /// # use sarzak::drawing_v1::SubtypeAnchors;
    /// # use sarzak::drawing_v1::Point;
    /// # use sarzak::drawing_v1::Edge;
    /// # let mut store = sarzak::drawing_v1::ObjectStore::new();
    ///
